          ...
          <div className="container">
            <div className="row">
              <div className="col-md-9">
                ...
                <a href=""><div className="payment visa"></div></a>
                <a href=""><div className="payment paypal"></div></a>
                <a href=""><div className="payment mc"></div></a>
                <a href=""><div className="payment nh"></div></a>
              </div>
